...
export const chatWithArticle = async (
  ...
  try {
    console.log(
      `💬 Chat request for article: ${articleId}, message: "${message}"`
    );
...
export const searchArticlesStream = (query = "", limit = 6, onUpdate) => {
  ...
  const url = `${baseURL}/api/articles/search-stream?query=${encodeURIComponent(
    query
  )}&limit=${limit}`;
  ...
  const mockArticles = [
    {
      ...
      summary:
        "Artificial intelligence technologies are reshaping financial markets worldwide, with new algorithms driving unprecedented trading volumes and market efficiency.",
      source: "Tech Today",
    ...
    },
    {
      ...
      summary:
        "World leaders have reached a groundbreaking consensus on climate action, setting ambitious targets for carbon reduction and renewable energy adoption.",
      source: "Global News",
    ...
    },
    {
      ...
      summary:
        "Rising inflation and geopolitical tensions are creating significant challenges for financial institutions, leading to increased market volatility.",
    ...
    },
    {
      ...
      summary:
        "Scientists have achieved a major milestone in quantum computing, demonstrating error correction capabilities that bring practical quantum computers closer to reality.",
    ...
    },
    {
      ...
      summary:
        "New medical technologies and treatment approaches are showing promise in addressing some of the world's most pressing health challenges.",
    ...
    },
    {
      ...
      summary:
        "International trade negotiations have reached a critical juncture as nations struggle to balance economic interests with diplomatic relationships.",
